...
const toolSites: Array<CardProps> = [
	{
		...
		nameAlt: 'shuoshuo',
		buttons: [
			{ icon: 'ph:planet-duotone', text: '访问', to: 'https://mm.qxzhan.cn/' },
	...
	},
	{
		...
		buttons: [
			{ icon: 'ph:planet-duotone', text: '访问', to: 'https://fc.qxzhan.cn/' },
	...
	},
	{
		...
		nameAlt: 'gists',
		buttons: [
			{ icon: 'ph:planet-duotone', text: '访问', to: 'https://gist.qxzhan.cn/all' },
	...
	},
	{
		...
		buttons: [
			{ icon: 'ph:planet-duotone', text: '访问', to: 'https://bing.qxzhan.cn/' },
	...
	{
		name: '友链状态',
		nameAlt: 'friend-status',
		buttons: [
			{ icon: 'ph:planet-duotone', text: '访问', to: 'https://check-flink.qxzhan.cn/' },
			{ icon: 'ph:github-logo-duotone', text: 'GitHub', to: 'https://github.com/willow-god/check-flink' },
		],
		desc: '一个简单的友链状态检查工具，用于检查友链是否正常',
	},
	{
		name: 'NewsNow',
		nameAlt: 'news',
		buttons: [
			{ icon: 'ph:planet-duotone', text: '访问', to: 'https://nn.qxzhan.cn/' },
	...
	},
	{
		...
		nameAlt: 'picsmaller',
		buttons: [
			{ icon: 'ph:planet-duotone', text: '访问', to: 'https://picsm.qxzhan.cn/' },
	...
	},
	{
		...
		nameAlt: 'share',
		buttons: [
			{ icon: 'ph:planet-duotone', text: '访问', to: 'https://share.qxzhan.cn/#/' },
